...
public class SubAuthProperties {
    ...
    private SubAuthUnsupportedOptionsPolicy unsupportedOptions = SubAuthUnsupportedOptionsPolicy.IGNORE;
    ...
    public SubAuthUnsupportedOptionsPolicy getUnsupportedOptions() { return unsupportedOptions; }
    public void setUnsupportedOptions(SubAuthUnsupportedOptionsPolicy unsupportedOptions) {
